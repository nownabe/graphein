...
const messages: Record<Locale, Record<string, string>> = {
  ja: {
    ...
    // Slack task shortcut
    "slack.task.title": "タスク作成",
    "slack.task.submit": "作成",
    "slack.task.cancel": "キャンセル",
    "slack.task.close": "閉じる",
    "slack.task.loading": "タスクを準備中です...",
    "slack.task.titleLabel": "タイトル",
    "slack.task.deadlineLabel": "期限",
    "slack.task.assigneesLabel": "アサインするユーザー",
    "slack.task.groupsLabel": "アサインするグループ",
    "slack.task.originalMessage": "元のメッセージ:",
    "slack.task.duplicate": "このメッセージからすでにタスクが作成されています: *{taskLink}*",
    "slack.task.duplicateSubmit": "作成する",
    "slack.task.error": "タスクの作成中にエラーが発生しました。もう一度お試しください。",
    "slack.task.replyAssigned": "タスク *{taskLink}* を {who} に割り当てました",
    "slack.task.replyFallbackAssignee": "担当者",

    // Snippets
    "nav.snippets": "日報",
    "page.snippets": "日報",
    "snippet.period.day": "日",
    "snippet.period.week": "週",
    "snippet.period.month": "月",
    "snippet.period.quarter": "四半期",
    "snippet.period.year": "年",
    "snippet.filter.postedBy": "投稿者",
    "snippet.filter.mentions": "メンション",
    "snippet.filter.mentionedUser": "メンションされたユーザー",
    "snippet.filter.mentionedUsergroup": "メンションされたグループ",
    "snippet.filter.all": "すべて",
    "snippet.filter.searchPoster": "投稿者を検索…",
    "snippet.empty": "この期間に日報はありません",
    "snippet.filter.sectionSelected": "選択中",
    "snippet.filter.sectionUsers": "ユーザー",
    "snippet.filter.sectionGroups": "グループ",
    "snippet.filter.searchUser": "ユーザーを検索…",
    "snippet.filter.searchUsergroup": "グループを検索…",
    "snippet.count.one": "件の日報",
    "snippet.count.other": "件の日報",
    "snippet.filter.noResults": "該当なし",
    "snippet.filter.ok": "OK",
    "snippet.filter.clear": "クリア",
    "snippet.filter.clearAll": "フィルターをリセット",
    "snippet.prev": "前へ",
    "snippet.next": "次へ",
    ...
    "slack.snippet.notUserMessage":
      "このメッセージはユーザーが投稿したものではないため、日報として追加できません。",
  ...
  en: {
    ...
    // Slack task shortcut
    "slack.task.title": "Create Task",
    "slack.task.submit": "Create",
    "slack.task.cancel": "Cancel",
    "slack.task.close": "Close",
    "slack.task.loading": "Preparing task...",
    "slack.task.titleLabel": "Title",
    "slack.task.deadlineLabel": "Deadline",
    "slack.task.assigneesLabel": "Assign to users",
    "slack.task.groupsLabel": "Assign to groups",
    "slack.task.originalMessage": "Original message:",
    "slack.task.duplicate": "A task has already been created from this message: *{taskLink}*",
    "slack.task.duplicateSubmit": "Create anyway",
    "slack.task.error": "An error occurred while creating the task. Please try again.",
    "slack.task.replyAssigned": "Assigned task *{taskLink}* to {who}",
    "slack.task.replyFallbackAssignee": "the assignee",

    // Snippets
    "nav.snippets": "Snippets",
    "page.snippets": "Snippets",
    "snippet.period.day": "Day",
    "snippet.period.week": "Week",
    "snippet.period.month": "Month",
    "snippet.period.quarter": "Quarter",
    "snippet.period.year": "Year",
    "snippet.filter.postedBy": "Posted by",
    "snippet.filter.mentions": "Mentions",
    "snippet.filter.mentionedUser": "Mentioned user",
    "snippet.filter.mentionedUsergroup": "Mentioned group",
    "snippet.filter.all": "All",
    "snippet.filter.searchPoster": "Search posters…",
    "snippet.empty": "No snippets for this period",
    "snippet.filter.sectionSelected": "Selected",
    "snippet.filter.sectionUsers": "Users",
    "snippet.filter.sectionGroups": "Groups",
    "snippet.filter.searchUser": "Search users…",
    "snippet.filter.searchUsergroup": "Search groups…",
    "snippet.count.one": "snippet",
    "snippet.count.other": "snippets",
    "snippet.filter.noResults": "No results",
    "snippet.filter.ok": "OK",
    "snippet.filter.clear": "Clear",
    "snippet.filter.clearAll": "Reset filters",
    "snippet.prev": "Previous",
    "snippet.next": "Next",
    ...
    "slack.snippet.notUserMessage":
      "This message was not posted by a user and cannot be added as a snippet.",
    "slack.snippet.deactivatedAuthor":
